...
class BatalhaNaval
{
    ...
    private bool PodePosicionarNavio(char[,] tabuleiro, int x, int y, int tamanho, bool horizontal)
    {
    ...
    private int PedirCoordenada(string tipo)
    {
        ...
        while (true)
        {
            ...
            if (int.TryParse(input, out coordenada) && coordenada >= 0 && coordenada < Tamanho)
            {
                return coordenada;
            }
            else
